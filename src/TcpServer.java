  ...
  the kind is determined by the socket number
    ...
    public void supportClients(IHandler handler) {
        ...
        Runnable mainServerLogic = () -> {
            this.threadPool = new ThreadPoolExecutor(10,10,
            ...
            try {
                ...
                ClientsNumber clientsNumber = new ClientsNumber();
                while(!stopServer){
                    ...
                    Runnable clientHandling = ()->{
                        ...
                        try {
                            requestHandler.handle(serverClientConnection.getInputStream(),serverClientConnection.getOutputStream(),clientsNumber);
    ...
    public static void main(String[] args) {
        ...
        Game game = new Game();
        webServer.supportClients(new ClientHandler(game));
